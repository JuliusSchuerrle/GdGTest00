...
public class StartMenu {
  public   ControlP5 menu;
    ...
    public StartMenu(MainClass applet, int FRAMEHEIGHT, int FRAMEWIDTH){
        this.applet = applet;
...
isMovingOut=true;   }
    ...
    private void setupMenu(){
        s1=menu.addButton("play");
        s2=menu.addButton("startColorMenu");
        s3=menu.addButton("startPresetsMenu");
        s4=menu.addButton("test4");
        s5=menu.addButton("test5");
        s6=menu.addButton("test6");
        s7=menu.addButton("test7");
        sliders.add(s1);
        sliders.add(s2);
        sliders.add(s3);
        sliders.add(s4);
